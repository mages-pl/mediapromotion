...
@section('content')
<div class="">
<div class="frontend__category_image" style="margin-bottom:20px;background-image:url({{ asset('img/category/furniture.jpg') }});background-size:cover;background-position:center;width:100%;height:250px;display:block;">
